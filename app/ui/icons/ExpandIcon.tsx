...
export const PieChartIcon = ({width,height,fill}:{width?:string,height?:string,fill?:string}) => {
    return (
        <svg fill={fill?fill:'#0D1317'} width={width?width:iconWidth} height={height?height:iconHeight} version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 60 60" xmlSpace="preserve">
            <g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
            <g id="SVGRepo_iconCarrier"> <g> 
                <path d="M51.31,51.092C56.678,45.668,60,38.216,60,30C60,13.458,46.542,0,30,0S0,13.458,0,30c0,8.219,3.324,15.673,8.696,21.097 c0.03,0.041,0.046,0.088,0.083,0.125s0.084,0.053,0.124,0.083C14.327,56.676,21.782,60,30,60c8.216,0,15.668-3.322,21.092-8.69 c0.043-0.031,0.092-0.048,0.131-0.087S51.279,51.135,51.31,51.092z M58,30c0,7.361-2.859,14.063-7.52,19.066l-7.791-7.791 C45.361,38.27,47,34.328,47,30c0-9.036-7.092-16.427-16-16.949V2.025C45.977,2.555,58,14.896,58,30z M30,45 c-8.271,0-15-6.729-15-15s6.729-15,15-15s15,6.729,15,15S38.271,45,30,45z M29,2.025v11.025C20.092,13.573,13,20.964,13,30 c0,4.328,1.639,8.27,4.311,11.275L9.52,49.066C4.859,44.063,2,37.361,2,30C2,14.896,14.023,2.555,29,2.025z M29,57 c-0.525,0-0.942,0.408-0.984,0.922c-1.482-0.104-2.932-0.324-4.342-0.651C23.495,57.106,23.262,57,23,57 c-0.083,0-0.157,0.028-0.234,0.047c-4.486-1.201-8.529-3.49-11.832-6.567l7.791-7.791c0.096,0.085,0.187,0.176,0.285,0.259 C19.01,42.966,19,42.981,19,43c0,0.552,0.448,1,1,1c0.105,0,0.202-0.03,0.297-0.06c0.676,0.472,1.391,0.888,2.134,1.26 C22.177,45.381,22,45.664,22,46c0,0.552,0.448,1,1,1s1-0.448,1-1c0-0.044-0.019-0.081-0.025-0.123C25.851,46.591,27.876,47,30,47 c1.428,0,2.807-0.196,4.133-0.529C34.303,46.781,34.621,47,35,47c0.552,0,1-0.448,1-1c0-0.038-0.017-0.07-0.021-0.106 c1.965-0.742,3.754-1.833,5.296-3.205l7.791,7.791c-0.389,0.362-0.785,0.717-1.194,1.057C47.703,51.222,47.382,51,47,51 c-0.552,0-1,0.448-1,1c0,0.29,0.127,0.545,0.324,0.728c-0.655,0.472-1.329,0.918-2.024,1.333C44.204,54.03,44.106,54,44,54 c-0.468,0-0.844,0.329-0.952,0.763c-2.26,1.195-4.7,2.093-7.27,2.634C35.595,57.162,35.322,57,35,57 c-0.447,0-0.812,0.298-0.94,0.702C32.734,57.896,31.379,58,30,58C30,57.448,29.552,57,29,57z"></path> 
                <circle cx="32" cy="49" r="1"></circle> 
                <circle cx="35" cy="52" r="1"></circle> 
                <circle cx="38" cy="49" r="1"></circle> 
                <circle cx="26" cy="49" r="1"></circle> 
                <circle cx="29" cy="52" r="1"></circle> 
                <circle cx="14" cy="49" r="1"></circle> 
                <circle cx="20" cy="49" r="1"></circle> 
                <circle cx="17" cy="46" r="1"></circle> 
                <circle cx="17" cy="52" r="1"></circle> 
                <circle cx="23" cy="52" r="1"></circle> 
                <circle cx="41" cy="46" r="1"></circle> 
                <circle cx="41" cy="52" r="1"></circle> 
                <circle cx="44" cy="49" r="1"></circle> 
                <circle cx="32" cy="55" r="1"></circle> 
                <circle cx="38" cy="55" r="1"></circle> 
                <circle cx="26" cy="55" r="1"></circle> 
...
export const MagnyfingGlass = ({width,height,fill}:{width?:string,height?:string,fill?:string}) => {
    return (
        <svg fill={fill?fill:"#0D1317"} width={width?width:iconWidth} height={height?height:iconHeight} version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 490.4 490.4" xmlSpace="preserve" stroke={fill?fill:"#0D1317"}>
            <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
            <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
            <g id="SVGRepo_iconCarrier"> 
                <g> 
...
export const ArrowIcon = ({width,height,fill}:{width?:string,height?:string,fill?:string}) => {
    return (
        <svg width={width?width:iconWidth} height={height?height:iconHeight} viewBox="0 0 24 24" role="img" xmlns="http://www.w3.org/2000/svg" stroke={fill?fill:"#000000"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none" color="#000000">
            <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
            <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
            <g id="SVGRepo_iconCarrier"> 
...
export const SwapIcon = ({width,height,fill}:{width?:string,height?:string,fill?:string}) => {
    return(
        <svg width={width?width:iconWidth} height={height?height:iconHeight} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
            <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
            <g id="SVGRepo_iconCarrier"> 
                <path d="M21 7.5L8 7.5M21 7.5L16.6667 3M21 7.5L16.6667 12" stroke={fill?fill:"#000000"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path> 
                <path d="M4 16.5L17 16.5M4 16.5L8.33333 21M4 16.5L8.33333 12" stroke={fill?fill:"#000000"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path> 
            </g>
        </svg>
    )
}
...
export const PictureIcon = ({width,height,fill,className}:{width?:string,height?:string,fill?:string,className?:string}) => {
    return(
...
export const UsersIcon = ({width,height,fill}:{width?:string,height?:string,fill?:string}) => {
    return (
        <svg viewBox="0 0 24 24" fill={fill? fill : "#000000"} width={width?width:iconWidth} height={height?height:iconHeight} xmlns="http://www.w3.org/2000/svg">
            <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
            <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
            <g id="SVGRepo_iconCarrier"> 
                <g clipPath="url(#clip0_1251_98416)"> 
                    <path fillRule="evenodd" fill={fill? fill : "#000000"} clipRule="evenodd" d="M9 0C5.96243 0 3.5 2.46243 3.5 5.5C3.5 8.53757 5.96243 11 9 11C12.0376 11 14.5 8.53757 14.5 5.5C14.5 2.46243 12.0376 0 9 0ZM5.5 5.5C5.5 3.567 7.067 2 9 2C10.933 2 12.5 3.567 12.5 5.5C12.5 7.433 10.933 9 9 9C7.067 9 5.5 7.433 5.5 5.5Z"></path> 
                    <path d="M15.5 0C14.9477 0 14.5 0.447715 14.5 1C14.5 1.55228 14.9477 2 15.5 2C17.433 2 19 3.567 19 5.5C19 7.433 17.433 9 15.5 9C14.9477 9 14.5 9.44771 14.5 10C14.5 10.5523 14.9477 11 15.5 11C18.5376 11 21 8.53757 21 5.5C21 2.46243 18.5376 0 15.5 0Z" fill={fill? fill : "#000000"}></path> 
                    <path d="M19.0837 14.0157C19.3048 13.5096 19.8943 13.2786 20.4004 13.4997C22.5174 14.4246 24 16.538 24 19V21C24 21.5523 23.5523 22 23 22C22.4477 22 22 21.5523 22 21V19C22 17.3613 21.0145 15.9505 19.5996 15.3324C19.0935 15.1113 18.8625 14.5217 19.0837 14.0157Z" fill={fill? fill : "#000000"}></path> 
                    <path d="M6 13C2.68629 13 0 15.6863 0 19V21C0 21.5523 0.447715 22 1 22C1.55228 22 2 21.5523 2 21V19C2 16.7909 3.79086 15 6 15H12C14.2091 15 16 16.7909 16 19V21C16 21.5523 16.4477 22 17 22C17.5523 22 18 21.5523 18 21V19C18 15.6863 15.3137 13 12 13H6Z" fill={fill? fill : "#000000"}></path> 
                </g> 
                <defs> 
                    <clipPath id="clip0_1251_98416"> <rect width="24" height="24" fill="white"></rect> </clipPath> 
                </defs> 
            </g>
        </svg>
    )
