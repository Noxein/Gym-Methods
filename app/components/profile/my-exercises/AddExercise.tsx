  ...
  return (
        <BlurBackgroundModal>
            <div className={`rounded-md flex flex-col px-10 py-4 gap-4 text-xl mb-20 w-full mx-5 text-white`} onClick={e=>e.stopPropagation()}>
                <Input labelName='Nazwa ćzwiczenia' value={exerciseName} onChange={e=>setExerciseName(e.target.value)}/>
                ...
                <div className='flex justify-around text-white gap-2'>
                    <Button onClick={addExercise} isPrimary className='flex-1'>Dodaj</Button>
                    <Button onClick={hideModal} className='flex-1'>Anuluj</Button>
                </div>
