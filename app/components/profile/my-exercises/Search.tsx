...
export const Search = ({setSearchValue,showAddModal,searchValue}:SearchTypes) => {
  ...
  return (
    <div className='flex gap-4'>
        <Input labelName={u("Search")} value={searchValue} onChange={e=>setSearchValue(e.target.value)}/>
