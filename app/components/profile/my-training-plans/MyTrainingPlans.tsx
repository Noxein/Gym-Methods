...
export const MyTrainingPlans = ({UserTrainings}:MyTrainingPlansTypes) => {
  ...
  return (
    <div className={`mx-6 text-${theme?.colorPallete.accent} mt-20`}>
        ...
        <button onClick={()=>setShowAddModal(!showAddModal)} className='flex justify-between w-full text-xl px-4 py-4 bg-green  rounded-lg mt-5'>Dodaj nowy trening <PlusIcon /></button>
