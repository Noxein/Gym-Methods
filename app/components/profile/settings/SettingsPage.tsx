        ...
        <h1 className='text-xl text-center text-white font-semibold'>{t("Settings")}</h1>
            ...
            <div className='flex flex-col gap-4 mb-20'>
                ...
                <div className='relative w-full text-white'>
                    ...
                    <div className='z-20 relative text-xs'>{t("Language")}</div>
...
const FixedDiv = ({children,showModal}:{children:React.ReactNode,showModal:React.Dispatch<React.SetStateAction<boolean>>}) => {
    ...
    return(
        <div className='mx-auto fixed top-0 max-w-mobile w-full z-20 backdrop-blur-sm flex justify-center overflow-auto bottom-20'>
            <div className='flex flex-col w-full overflow-y-auto'>
                <button onClick={handleCloseModal} className='py-3 text-white bg-dark border-1 border-marmur my-5 rounded-lg'>
                    Powrót
                </button>
