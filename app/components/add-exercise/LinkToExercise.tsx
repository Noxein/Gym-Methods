...
export const LinkToExercise = ({text,mLeft,isFirst,leadTo}:LinkToExerciseType) => {
    ...
    return(
        <Link className={`relative text-left ml-${mLeft} bg-marmur text-marmur border-marmur border-[1px] rounded flex justify-between ${isFirst?'mt-2':null}`} href={`/home/add-exercise/${leadTo.trim()}`}>
